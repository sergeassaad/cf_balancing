...
class cfr_net(object):
    ...
    def __init__(self, x, t, y_ , p_t, e, FLAGS, r_alpha, r_lambda, do_in, do_out, dims):
        self.variables = {}
        self.wd_loss = 0
        ...
        self._build_graph(x, t, y_ , p_t, e, FLAGS, r_alpha, r_lambda, do_in, do_out, dims)
    ...
    def _build_graph(self, x, t, y_ , p_t, e, FLAGS, r_alpha, r_lambda, do_in, do_out, dims):
        """
